...
setup(
    ...
    author="xx",
    author_email="sales@xx.com",
    description=f"Machine learning compiler based on MLIR for xx TPU {os.getenv('mlir_version').split('-')[0]}-g{os.getenv('mlir_commit_id')}-{os.getenv('mlir_commit_date')}",
    long_description=open('README.md').read(),
    long_description_content_type='text/markdown',
    license="2-Clause BSD",
    platforms="unbuntu22.04",
    python_requires=">=3.10,<3.11",
    url="https://anonymous.4open.science/r/tpu-mlir-1F0F",
