...
from tt_mq.utils.registry import register_weight_equalization_function, WEIGHT_EQUALIZATION_FUNCTION
from tt_mq.fake_quantize.tqt import TqtFakeQuantize
